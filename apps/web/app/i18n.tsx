...
const dictionaries: Record<Locale, Dictionary> = {
  fr: {
    ...
    "signup.error": "Création du compte impossible pour le moment. Vérifiez l'e-mail, le mot de passe puis réessayez.",
  ...
  en: {
    ...
    "signup.error": "We cannot create the account right now. Check the email, password, and try again.",
