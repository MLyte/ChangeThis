...
- `AUTH_MODE=supabase`, `DATA_STORE=supabase`; `ENABLE_PUBLIC_SIGNUP` selon l'etat d'ouverture voulu.
...
- [ ] `AUTH_MODE=supabase`, `DATA_STORE=supabase`, `ENABLE_PUBLIC_SIGNUP` volontairement choisi.
