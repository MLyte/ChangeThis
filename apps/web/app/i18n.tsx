...
const dictionaries: Record<Locale, Dictionary> = {
  fr: {
    ...
    "home.publicSector.notReplace.certification": "Accès console réservés aux personnes qui traitent les retours.",
  ...
  en: {
    ...
    "home.publicSector.notReplace.certification": "Console access reserved for the people handling feedback.",
