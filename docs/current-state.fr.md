...
- Le signup public est ouvert par defaut pour la beta ouverte; definir `PUBLIC_SIGNUP_PAUSED=true` pour reserver un environnement ou mettre les inscriptions en pause operationnelle.
