...
const dictionaries: Record<Locale, Dictionary> = {
  fr: {
    ...
    "signup.lede": "Indiquez votre e-mail professionnel. Nous vous envoyons un lien sécurisé pour vérifier l'adresse et choisir votre mot de passe.",
    "signup.organization": "Nom de l'organisation",
    "signup.password": "Mot de passe",
    "signup.submit": "Recevoir le lien sécurisé",
    "signup.localSubmit": "Ouvrir la console locale",
    "signup.redirectHint": "Le lien reçu par e-mail vous permettra de choisir votre mot de passe avant d'ouvrir l'espace.",
    ...
    "home.console.primary": "Ouvrir la console",
    ...
    "home.closing.eyebrow": "Bêta ouverte",
  ...
  en: {
    ...
    "signup.lede": "Enter your work email. We will send a secure link to verify the address and let you choose your password.",
    "signup.organization": "Organization name",
    "signup.password": "Password",
    "signup.submit": "Send secure link",
    "signup.localSubmit": "Open local console",
    "signup.redirectHint": "The email link lets you choose your password before opening the workspace.",
    "signup.loginHint": "Already have an account?",
    "login.signupHint": "Need an account?",
    "signup.error": "We cannot send the secure link right now. Check the email and try again.",
    ...
    "home.console.primary": "Open console",
    ...
    "home.closing.eyebrow": "Open beta",
