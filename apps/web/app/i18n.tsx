...
const dictionaries: Record<Locale, Dictionary> = {
  fr: {
    ...
    "projects.inbox.retryDue": "Rejouer les relances dues",
    ...
    "destinations.integration.githubLocalHelp": "Le plus direct en local : un token avec accès Issues en lecture/écriture sur le dépôt cible.",
  ...
  en: {
    ...
    "destinations.integration.githubLocalHelp": "Fastest locally: a token with read/write Issues access on the target repository.",
