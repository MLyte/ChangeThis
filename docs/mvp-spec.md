...
1. Done/partial: issue provider flow for GitHub and GitLab, presented neutrally according to each team's repository.
...
- Public homepage: waitlist-first marketing page, not open signup.
